...
import RenderHtml from "../../widgets/RenderHtml";
...
export function DslCard(props: Props) {
  ...
  const navigation =
    dsl.navigation === "eip" ? "EIP" : capitalize(dsl.navigation);
  const labels =
    dsl.labels !== undefined
  ...
  return (
    ...
    >
      ...
      <CardBody>
        ...
        <Tooltip
          content={dsl.description}
          position={TooltipPosition.bottom}
          entryDelay={1000}
        >
          <Text className="pf-v5-u-color-200">
            {dsl.navigation === "interface Source" ||
            dsl.navigation === "interface Target" ? (
              <RenderHtml htmlString={dsl.description} />
            ) : (
              dsl.description
            )}
          </Text>
