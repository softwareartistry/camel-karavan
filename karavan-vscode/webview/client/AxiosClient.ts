...
class AxiosClient {
	...
	RouteControllerApi!: RouteControllerApi;
	...
	init = (baseURL: string, authToken: string): void => {
		...
		this.InterfaceControllerApi = new InterfaceControllerApi(undefined, baseURL, this.client);
		this.KeycloakControllerApi = new KeycloakControllerApi(undefined, baseURL, this.client);
		this.RouteControllerApi = new RouteControllerApi(undefined, baseURL, this.client);
		this.MessageControllerApi = new MessageControllerApi(undefined, baseURL, this.client);
		this.RepositoryControllerApi = new RepositoryControllerApi(undefined, baseURL, this.client);
		this.SchemaControllerApi = new SchemaControllerApi(undefined, baseURL, this.client);
	};
